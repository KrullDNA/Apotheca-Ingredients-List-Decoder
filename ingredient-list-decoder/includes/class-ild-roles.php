...
class ILD_Roles {
	...
	public static function get_roles() {
		...
		return array(
			...
			'solubiliser'          => __( 'Solubiliser', 'ingredient-list-decoder' ),
			'thickener'            => __( 'Thickener', 'ingredient-list-decoder' ),
			'solvent'              => __( 'Solvent', 'ingredient-list-decoder' ),
			'carrier'              => __( 'Carrier', 'ingredient-list-decoder' ),
			'surfactant'           => __( 'Surfactant', 'ingredient-list-decoder' ),
			'preservative'         => __( 'Preservative', 'ingredient-list-decoder' ),
			'preservative-booster' => __( 'Preservative booster', 'ingredient-list-decoder' ),
			'chelator'             => __( 'Chelator', 'ingredient-list-decoder' ),
			'ph-adjuster'          => __( 'pH adjuster', 'ingredient-list-decoder' ),
			'buffering'            => __( 'Buffering', 'ingredient-list-decoder' ),
			'stabiliser'           => __( 'Stabiliser', 'ingredient-list-decoder' ),
			'film-former'          => __( 'Film former', 'ingredient-list-decoder' ),
			'fragrance'            => __( 'Fragrance', 'ingredient-list-decoder' ),
			'fragrance-allergen'   => __( 'Fragrance allergen', 'ingredient-list-decoder' ),
			'colourant'            => __( 'Colourant', 'ingredient-list-decoder' ),
			'pigment'              => __( 'Pigment', 'ingredient-list-decoder' ),
			'opacifier'            => __( 'Opacifier', 'ingredient-list-decoder' ),
			'absorbent'            => __( 'Absorbent', 'ingredient-list-decoder' ),
			'filler'               => __( 'Filler', 'ingredient-list-decoder' ),
			'slip-modifier'        => __( 'Slip modifier', 'ingredient-list-decoder' ),
			'binder'               => __( 'Binder', 'ingredient-list-decoder' ),
			'coating'              => __( 'Coating', 'ingredient-list-decoder' ),
			'dispersant'           => __( 'Dispersant', 'ingredient-list-decoder' ),
			'wax'                  => __( 'Wax', 'ingredient-list-decoder' ),
			'silicone'             => __( 'Silicone', 'ingredient-list-decoder' ),
			'exfoliant'            => __( 'Exfoliant', 'ingredient-list-decoder' ),
			'soothing'             => __( 'Soothing', 'ingredient-list-decoder' ),
			'astringent'           => __( 'Astringent', 'ingredient-list-decoder' ),
			'viscosity-modifier'   => __( 'Viscosity modifier', 'ingredient-list-decoder' ),
